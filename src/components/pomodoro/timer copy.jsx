...
export default function Pomodoro() {
		...
		if (isTimeUp) {
			if (stage === 0) {
				...
				if ((completedPomodoros + 1) % 4 === 0) {
					switchStage(2) // Move to Long Break after 4 Pomodoro sessions
				} else {
					switchStage(1) // Move to Short Break
				}
			} else {
				switchStage(0) // Move to Pomodoro
			}
		}
	...
	return (
		<div className="mx-auto mt-10 flex w-10/12 flex-col items-center justify-center pt-5">
			...
			{/* Reset button + Play in PiP button */}
			...
			<button
				className="mt-3 rounded-2xl bg-green-lightest p-2 px-4 uppercase text-black"
